...
export default function Home() {
  ...
  <section className="flex flex-row flex-auto gap-10 items-center w-full justify-between pt-20 ">
    ...
    <article className="cursor-pointer">
      <Image src="/hero.png" width="500" height="401" alt="heroNft" className="rounded-t-3xl"></Image>
      <div className="flex flex-col gap-4 bg-secondary p-5 rounded-b-3xl">
        <h5 className="font-semibold">Space Walking</h5>
        <div className="flex flex-auto gap-4">

        <Image src="/images/Avatars/Avatar1.svg" width="24" height="24" alt="artist" ></Image>
  ...
  <section className="flex flex-col flex-auto gap-24 items-start w-full">
    ...
    <div className="flex justify-between w-full">
      <Trending artist="Mr Fox" trending1="/images/nfts/doggo.svg" trending2="/images/nfts/rabbit.svg" trending3="/images/nfts/bear.svg" profile="/images/Avatars/Avatar6.svg" title="DSGN Animals"/>
      <Trending artist="Shroomie" trending1="/images/nfts/BigMush.svg" trending2="/images/nfts/mediumMush.svg" trending3="/images/nfts/smallMush.svg" profile="/images/Avatars/Avatar7.svg" title="Magic Mushrooms"/>
      <Trending artist="BeKind2Robots" trending1="/images/nfts/bigRobot.svg" trending2="/images/nfts/mediumRobot.svg" trending3="/images/nfts/smallRobot.svg" profile="/images/Avatars/Avatar12.svg" title="DSGN Animals"/>
    </div>
  </section>
